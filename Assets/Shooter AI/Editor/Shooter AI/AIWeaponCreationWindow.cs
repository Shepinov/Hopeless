...
private string nameOfObject = "Prefabs/Weapons/WeaponEmptyPrefab"; //the name of instance that we use as a prefab for the ai
...
EditorGUILayout.BeginHorizontal();
{
EditorGUILayout.LabelField("Please select the bullet object");
bulletToUse = EditorGUILayout.ObjectField(bulletToUse, typeof(Rigidbody), true) as Rigidbody;
}
EditorGUILayout.EndHorizontal();

EditorGUILayout.BeginHorizontal();
{
EditorGUILayout.LabelField("Please select the empty magazine object");
emptyMagazine = EditorGUILayout.ObjectField(emptyMagazine, typeof(Rigidbody), true) as Rigidbody;
}
EditorGUILayout.EndHorizontal();
...
newAI.GetComponent<AIWeaponSelected>().magazineObjectThrow = emptyMagazine.gameObject;
newAI.GetComponent<AIWeaponShoot>().bulletToUse = bulletToUse.gameObject;
