...
[AddComponentMenu("Pathfinding/AI/AIPath (Shooter AI)")]
public class ShooterAIPathFinder : MonoBehaviour {
	...
	public virtual void SearchPath ( Vector3 newTarget) {
	...
	public virtual void Update () {
		...
		if (navController != null) {
			...
			//Debug.Log("Moveeee: " + dir + " Speed: " + speed );
	...
	public Vector3 CalculateVelocity (Vector3 currentPosition) {
		...
		//FOR FUTURE USERS: THIS CODE COULD BE TOTALLY FALSE, BUT IT WORKS AND IS USED IN THE "if" FUNTION BELOW
		//PLEASE CONTACT ME IF YOU FIND A BETTER WAY
		//Debug.Log("Dist" + ( vPath[currentWaypointIndex] - currentPosition ).magnitude );
		
		
		
		if (currentWaypointIndex == vPath.Count-1 && ( vPath[currentWaypointIndex] - currentPosition ).magnitude <= endReachedDistance) 
		{
