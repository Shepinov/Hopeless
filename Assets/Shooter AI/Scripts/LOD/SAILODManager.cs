...
public class SAILODManager : MonoBehaviour {
	
	public GameObject mainMeshObject = null; //the gameobject with the main mesh that should be LOD
	...
	{
		//set caches
		meshRender = mainMeshObject.GetComponent<SkinnedMeshRenderer>();
	}
