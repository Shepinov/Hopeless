...
public class RagdollHelper : MonoBehaviour {
	...
	void Awake()
	{
		...
		GetComponent<RagdollTransitions>().enabled = true;
		if(GetComponent<RagdollTransitions>().useAutoRootObject == true)
		{
			GetComponent<RagdollTransitions>().boneParent = GetComponent<Animator>().GetBoneTransform(HumanBodyBones.Hips).gameObject;
		}
